...
public class SolarPanel extends Sprite{
    public World world;
    public Body body;
    ...
    public SolarPanel(GameScreen screen, float x, float y) {
        ...
        setRegion(SplashScreen.manager.get("solarpanel.png", Texture.class));
    }

    public void defineSolarPanel() {
    ...
    public void update(float delta) {
        if(collected && !destroyed) {
            ...
            destroyed = true;
            SplashScreen.manager.get("solar.wav", Sound.class).play();
        } else if(!destroyed) {
